      ...
      <div className="flex-1 ">
       ...
       <p className=" uppercase text-sm ml-2"> <span className="text-white text-sm ">20% </span>
        ...
        <div className=" flex flex-col md:flex-row w-full  py-8 gap-10 ">
         ...
         <h1 className="flex-1  text-4xl md:text-5xl text-white capitalize leading-[75px] font-semibold ">
          ...
          <p className="py-2 max-w-sm text-white text-md md:text-sm font-normal mt-4">
