  ...
  return (
    <div className="flex my-28 w-full  ">
      <div className="flex-1 ">
        <div className="flex items-center bg-discount-gradient rounded-full  px-4 mb-2 w-[388px]">
       ...
       <p className=" uppercase text-sm ml-2"> <span className="text-white text-sm ">20% </span>
        ...
        <div className=" flex flex-col w-full h-[303px] py-8  ">
        <div className="flex justify-between ">
        <h1 className="flex-1 text-5xl text-white capitalize leading-[75px] font-semibold ">
          ...
          <h1 className=" text-5xl text-white capitalize  font-semibold w-full leading-[75px] ">
            payment method .
          </h1>
          <p className="py-2 max-w-sm text-white text-sm font-normal mt-4">
      ...
      <div className=" relative z-[5]  "><img src={robot} alt="robot hand"  height={674} width={669}/>
