  ...
  return (
    <div className="w-full  h-[40px]">
      ...
      <nav className="flex   justify-between items-center py-6 text-sm ">
        ...
        <ul className={open ?"flex flex-col items-center justify-center gap-10 py-20  text-[#fff] testimonial h-[500px]   fixed top-0 left-0 w-[250px] capitalize  ease-in-out duration-500 z-[300]":"fixed left-[-100%]"}>
