...
const Statistic = () => {
  return (
    <div className='w-full flex flex-wrap  gap-10  items-center justify-center md:items-start text-white'>
        {stat.map((stats,index)=>{
            return <div key={index} className='flex w-full   items-center   max-w-[350px] '>
                ...
                <p className='text-xl capitalize text-gradient py-4 '>{stats.title}</p>
