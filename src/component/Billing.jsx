...
<div className="absolute z-[2] w-[50%] h-[50%]  blue__gradient rounded-full -left-1/2"/>
      ...
      <div className='text-white flex flex-col  justify-center  flex-1 mx-32  '>
        <h2 className='max-w-[260px] text-3xl font-semibold leading-[40px]'>Easily control your billing & invoicing.</h2>
